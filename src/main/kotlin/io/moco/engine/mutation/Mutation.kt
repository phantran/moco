...
data class Mutation (
    ...
    @JsonIgnore var optionalInfo: MutableMap<String, Any?>? = mutableMapOf(),
    @JsonProperty("instructionOrder") var instructionsOrder: MutableList<String> = mutableListOf(),  // Additional information about the mutant
