...
package io.github.phantran.engine.operator

import io.github.phantran.engine.MethodInfo
import io.github.phantran.engine.mutator.replacement.AOR
import io.github.phantran.engine.mutator.replacement.BLR
import io.github.phantran.engine.mutator.replacement.ROR
...
class ReplacementOperator(override val operatorName: String): Operator {
    ...
    override fun generateVisitor(
        ...
        return when (operatorName) {
            "AOR" -> AOR(this, tracker, delegateMethodVisitor)
            "ROR" -> ROR(this, tracker, delegateMethodVisitor)
            "BLR" -> BLR(this, tracker, delegateMethodVisitor)
            else -> null
        }
    }
}