...
package io.github.phantran.engine.tracker
...
class MutatedClassTracker(val targetMutation: Mutation? = null,
    ...
    // If number of mutations per line is limited by filterMutants parameter
    // the tracker of the number of mutations of each line will be initialized and not null
    val mutationLimitTracker: MutableMap<Int, MutableSet<String>>? = if (filterMutants) mutableMapOf() else null
