...
class ClassNameTest: AnnotationSpec()  {
    ...
    fun testClsNameToClass() {
        ClassName.clsNameToClass(ClassName("io.github.phantran.engine.ClassInfo")) shouldBe ClassInfo::class.java
        ClassName.clsNameToClass(ClassName("io.github.phantran.engine.ClassInfo1")) shouldBe null
    }
}